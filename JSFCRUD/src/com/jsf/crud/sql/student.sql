...
CREATE TABLE student_record (student_id INT NOT NULL AUTO_INCREMENT, student_name VARCHAR(100), student_email VARCHAR(50), student_password VARCHAR(20), student_gender VARCHAR(1), student_address VARCHAR(100), PRIMARY KEY (student_id));
